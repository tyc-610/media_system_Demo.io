...
CSRCS 			+=./src/start_video.c ./src/screen.c ./src/main_screen.c ./src/kugou_music.c ./src/dcim.c ./src/data.c ./src/my_font.c 
...
default: $(TARGET)
	...
	@echo "Copying $(BIN) to /home/china/tftpboot..."
    @cp $(BUILD_BIN_DIR)/$(BIN) /home/china/tftpboot/
    @echo "Copy completed."
